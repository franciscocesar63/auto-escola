...
<!--[if gt IE 8]><!--> <html class="no-js" lang="pt"> <!--<![endif]-->
    ...
    <body>
        ...
        <div class="container" style="margin-top: 20px;border: 5px solid;border-radius: 25px;">
            ...
            <h4>Pesquisar Instrutor</h4>
            <form action="processa-instrutor.php" autocomplete="off">
                <input class="form-control" type="text" name="pesquisaInstrutor" id="pesquisaInstrutor" placeholder="Digite Aqui">
            </form>


            <div id="resultadoInstrutor">
                <?php
...
//                $pdo = connectar();
                $query = $pdo->prepare("SELECT * FROM pessoa p INNER JOIN instrutor i ON p.id=i.id AND i.excluido=0"
