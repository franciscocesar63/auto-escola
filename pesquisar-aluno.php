    ...
    <body>
        ...
        <div class="container" style="margin-top: 20px;border: 5px solid;border-radius: 25px;">
            ...
            <form method="post" autocomplete="off">
                <input class="form-control" type="text" name="pesquisa" id="pesquisa" placeholder="Digite Aqui">
            </form>
...
//                $pdo = connectar();
                ...
                $query = $pdo->prepare("SELECT * FROM pessoa p INNER JOIN aluno a ON p.id=a.id AND a.excluido=0"
                        . " AND p.excluido=0 LIMIT 10");
                $query->execute();
...
//        echo 'id: ' . $id;
        if (isset($id)) {
            ...
            $query_test = $pdo->prepare("SELECT * FROM pessoa p INNER JOIN aluno a ON p.id=a.id AND a.excluido=0"
                    . " WHERE p.id= AND p.excluido=0 LIMIT 10");
            $query_test->execute();
            ...
            <div class = "modal-dialog modal-lg">
                <div class = "modal-content">
                    ...
                    <div class = "modal-header">
                        <h4 class = "modal-title">Visualizar Aluno</h4>
