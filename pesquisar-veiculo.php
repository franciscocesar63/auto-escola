...
<!--[if gt IE 8]><!--> <html class="no-js" lang="pt"> <!--<![endif]-->
    ...
    <body>
        ...
        <div class="container" style="margin-top: 20px;border: 5px solid;border-radius: 25px;">
            ...
            <form action="processa-veiculo.php" autocomplete="off">
                <input class="form-control" type="text" name="pesquisaVeiculo" id="pesquisaVeiculo" placeholder="Digite Aqui">
            </form>


            <div id="resultadoVeiculo">
                <?php
                if (!isset($_SESSION)) {
                    session_start();
                }
...
//        echo 'id: ' . $id;
        if (isset($id)) {
            ...
            $query_test = $pdo->prepare("SELECT * FROM veiculo LIMIT 10");
            $query_test->execute();
            ...
            <div class = "modal-dialog modal-lg">
                <div class = "modal-content">
                    ...
                    <div class = "modal-header">
                        <h4 class = "modal-title">Visualizar Veículo</h4>
