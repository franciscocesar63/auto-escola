...
CONSTRAINT pk_id_aluno_idAula PRIMARY KEY(id_aluno, id_aula),
...
CREATE PROCEDURE insert_pessoa(param_nome VARCHAR(30), param_sexo ENUM('masculino', 'feminino'), param_cpf VARCHAR(11), param_rg VARCHAR(11), 
	...
	BEGIN
        ...
        VALUES(param_logradouro, param_numero_casa, param_bairro, param_complemento, param_cep, param_cidade);
...
CREATE PROCEDURE insert_aluno(param_nome VARCHAR(30), param_sexo ENUM('masculino', 'feminino'), param_cpf VARCHAR(11), param_rg VARCHAR(11), 
					param_email VARCHAR(30), param_telefone VARCHAR(18), param_logradouro VARCHAR(30), param_numero_casa VARCHAR(10), 
                    param_bairro VARCHAR(30), param_complemento VARCHAR(30), param_cep VARCHAR(15), param_cidade VARCHAR(30))
	BEGIN 
...
CREATE PROCEDURE insert_veiculo(param_modelo VARCHAR(30), param_marca VARCHAR(30),param_ano YEAR, param_placa VARCHAR(30), param_chassi VARCHAR(30), 
		param_tipo_veiculo Enum('carro', 'moto'))
	BEGIN
