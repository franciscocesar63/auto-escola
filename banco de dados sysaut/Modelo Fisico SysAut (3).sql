...
CREATE PROCEDURE insert_pessoa(iNome VARCHAR(30), iSexo ENUM('masculino', 'feminino'),iCpf VARCHAR(11), iRg VARCHAR(11), iEmail VARCHAR(30), iTelefone VARCHAR(18), 
					iLogradouro VARCHAR(30), iNumeroCasa INT, iBairro VARCHAR(30), iComplemento VARCHAR(30), iCep VARCHAR(15), iCidade VARCHAR(30))
	BEGIN
		INSERT INTO sysaut.endereco(logradouro, numero, bairro, complemento, cep, cidade) 
        VALUES(iLogradouro, iNumeroCasa, iBairro, iComplemento, iCep, iCidade);
        INSERT INTO sysaut.pessoa(nome, sexo, cpf, rg, email, idEndereco) 
        VALUES(iNome, iSexo, iCpf, iRg, iEmail, last_insert_id());
        INSERT INTO sysaut.telefone(idPessoa, numero) VALUE(last_insert_id(), iTelefone);
	END $$
    
CREATE PROCEDURE insert_aluno(iNome VARCHAR(30), iSexo ENUM('masculino', 'feminino'), iCpf VARCHAR(11), iRg VARCHAR(11), iEmail VARCHAR(30), iTelefone VARCHAR(18), 
					iLogradouro VARCHAR(30), iNumeroCasa INT, iBairro VARCHAR(30), iComplemento VARCHAR(30), iCep VARCHAR(15), iCidade VARCHAR(30))
	BEGIN 
		CALL insert_pessoa(iNome, iCpf, iRg, iEmail, iTelefone, iLogradouro, iNumeroCasa, iBairro, iComplemento, iCep, iCidade);
        INSERT INTO sysaut.aluno(idAluno, dataIngresso) VALUES(last_insert_id(), UTC_DATE());
	END $$
 

CREATE PROCEDURE insert_instrutor(iNome VARCHAR(30), iSexo ENUM('masculino', 'feminino'),iCpf VARCHAR(11), iRg VARCHAR(11), iEmail VARCHAR(30), iTelefone VARCHAR(18), 
					iLogradouro VARCHAR(30), iNumeroCasa INT, iBairro VARCHAR(30), iComplemento VARCHAR(30), iCep VARCHAR(15), iCidade VARCHAR(30), 
                    iLogin VARCHAR(30), iSenha VARCHAR(30), iPermissao ENUM('1','2','3'), iCargo ENUM('gerente', 'instrutor', 'secretaria'), iSalario DECIMAL, iNumeroCNH VARCHAR(30))
	BEGIN
		CALL insert_pessoa(iNome, iSexo, iCpf, iRg, iEmail, iTelefone, iLogradouro, iNumeroCasa, iBairro, iComplemento, iCep, iCidade);
        INSERT INTO sysaut.usuario(idUsuario, login, senha, permissao) VALUES(last_insert_id(), iLogin, iSenha, iPermissao);
        INSERT INTO sysaut.funcionario(idFuncionario, cargo, salario, dataAdmissao) VALUES(last_insert_id(), iCargo, iSalario, UTC_DATE());
        INSERT INTO sysaut.instrutor(idInstrutor, numeroCNH) VALUES (last_insert_id(), iNumeroCNH); 
    END $$

CREATE PROCEDURE insert_secretaria(iNome VARCHAR(30), iSexo ENUM('masculino', 'feminino'),iCpf VARCHAR(11), iRg VARCHAR(11), iEmail VARCHAR(30), iTelefone VARCHAR(18), 
					iLogradouro VARCHAR(30), iNumeroCasa INT, iBairro VARCHAR(30), iComplemento VARCHAR(30), iCep VARCHAR(15), iCidade VARCHAR(30), 
                    iLogin VARCHAR(30), iSenha VARCHAR(30), iPermissao ENUM('1','2','3'), iCargo ENUM('gerente', 'instrutor', 'secretaria'), iSalario DECIMAL)
	BEGIN
		CALL insert_pessoa(iNome, iSexo, iCpf, iRg, iEmail, iTelefone, iLogradouro, iNumeroCasa, iBairro, iComplemento, iCep, iCidade);
        INSERT INTO sysaut.usuario(idUsuario, login, senha, permissao) VALUES(last_insert_id(), iLogin, iSenha, iPermissao);
        INSERT INTO sysaut.funcionario(idFuncionario, cargo, salario, dataAdmissao) VALUES(last_insert_id(), iCargo, iSalario, UTC_DATE());
        INSERT INTO sysaut.secretaria(idSecretaria) VALUES (last_insert_id()); 
    END $$

 CREATE PROCEDURE insert_gerente(iNome VARCHAR(30), iSexo ENUM('masculino', 'feminino'),iCpf VARCHAR(11), iRg VARCHAR(11), iEmail VARCHAR(30), iTelefone VARCHAR(18), 
					iLogradouro VARCHAR(30), iNumeroCasa INT, iBairro VARCHAR(30), iComplemento VARCHAR(30), iCep VARCHAR(15), iCidade VARCHAR(30), 
                    iLogin VARCHAR(30), iSenha VARCHAR(30), iPermissao ENUM('1','2','3'), iCargo ENUM('gerente', 'instrutor', 'secretaria'), iSalario DECIMAL)
	BEGIN
		CALL insert_pessoa(iNome, iSexo, iCpf, iRg, iEmail, iTelefone, iLogradouro, iNumeroCasa, iBairro, iComplemento, iCep, iCidade);
        INSERT INTO sysaut.usuario(idUsuario, login, senha, permissao) VALUES(last_insert_id(), iLogin, iSenha, iPermissao);
        INSERT INTO sysaut.funcionario(idFuncionario, cargo, salario, dataAdmissao) VALUES(last_insert_id(), iCargo, iSalario, UTC_DATE());
        INSERT INTO sysaut.gerente(idGerente) VALUES (last_insert_id()); 
    END $$
 
CREATE PROCEDURE insert_aula_teorica(iTipo VARCHAR(7), iDataAula DATE, iInicio TIME, iDuracao TIME, iQuantidade INT, iIdInstrutor INT, 
					iAssunto VARCHAR(30))
	BEGIN
		INSERT INTO sysaut.aula(tipo, dataAula, inicio, duracao, quantidade, idInstrutor) 
        VALUES(iTipo, iDataAula, iInicio, iDuracao, iQuantidade, iIdInstrutor);
        INSERT INTO sysaut.teorica(idTeoria, assunto) VALUES(last_insert_id(), iAssunto); 
    END $$
 
 CREATE PROCEDURE insert_aula_pratica(iTipo VARCHAR(7), iDataAula DATE, iInicio TIME, iDuracao TIME, iQuantidade INT, iIdInstrutor INT, 
					iIdVeiculo INT)
	BEGIN
		INSERT INTO sysaut.aula(tipo, dataAula, inicio, duracao, quantidade, idInstrutor) 
        VALUES(iTipo, iDataAula, iInicio, iDuracao, iQuantidade, iIdInstrutor);
...
CREATE PROCEDURE insert_veiculo(iModelo VARCHAR(30), iMarca VARCHAR(30), iAno YEAR, iPlaca VARCHAR(30), iChassi VARCHAR(30), 
	...
	BEGIN
		INSERT INTO sysaut.veiculo(modelo, marca, ano, placa, chassi, tipoVeiculo) VALUES(iModelo, iMarca, iAno, iPlaca, iChassi, iTipoVeiculo);
	END $$
DELIMITER ;
