...
CREATE PROCEDURE insert_aula_teorica(iTipo VARCHAR(7), iDataAula DATE, iInicio TIME, iDuracao TIME, iQuantidade INT, iIdInstrutor INT, 
					iAssunto VARCHAR(30))
	BEGIN
		INSERT INTO aula(tipo, dataAula, inicio, duracao, quantidade, idInstrutor) 
...
CALL insert_aluno('Anderson', 'masculino', '231234545', '23123411', 'sdadadd@asdd', '98823232', 'Rua A', '54', 'Bairro A', '-----', '233344442', 'Cidade A');

-- DROP PROCEDURE insert_aluno;


-- DROP DATABASE projetobd1;